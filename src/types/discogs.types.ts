...
export interface DiscogsReleasesResponseInterface
  extends DiscogsResponseInterface {
...
export interface DiscogsWantsResponseInterface
  extends DiscogsResponseInterface {
...
export interface DiscogsWantsWithReservedInterface
  extends DiscogsWantsInterface {
  reserved?: boolean;
}
